...
#if F_CPU==16000000
#define ser_write(value) TinyDebugSerialWriterBangOneByte(value,0b11110,0b11111,0,39,1)
#elif F_CPU==8000000
#define ser_write(value) TinyDebugSerialWriterBangOneByte(value,0b01010,0b10100,0,16,1);
#else
#error
#endif
